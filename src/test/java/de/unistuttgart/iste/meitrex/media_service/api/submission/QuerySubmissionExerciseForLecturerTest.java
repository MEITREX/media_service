...
@Transactional
@GraphQlApiTest
public class QuerySubmissionExerciseForLecturerTest {
    @Autowired
    ...
    void testCreateExerciseFile(final HttpGraphQlTester tester) {
        ...
        assertThat(solution2.getUserId(), is(user2Id));
        assertThat(solution2.getFiles().get(0).getDownloadUrl(), is("http://example.com"));
        assertThat(solution2.getResult().getStatus(), is(Status.pending));
        assertThat(solution2.getResult().getResults(), hasSize(1));
        assertThat(solution2.getResult().getResults().get(0).getItemId(), is(itemId));
        assertThat(solution2.getResult().getResults().get(0).getScore(), is(100));
    }
}
