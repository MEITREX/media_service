...
class QueryMediaRecordsTest {
    ...
    void testQueryAllMediaRecords(final GraphQlTester tester) {
        final List<MediaRecordEntity> expectedMediaRecords = MediaRecordRepositoryUtil.fillRepositoryWithMediaRecordsAndCourseIds(repository, courseId1, courseId2);
    ...
    void testQueryMediaRecordsByIds(final GraphQlTester tester) {
        final List<MediaRecordEntity> expectedMediaRecords = MediaRecordRepositoryUtil.fillRepositoryWithMediaRecords(repository);
